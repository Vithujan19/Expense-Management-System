    ...
    return (
        ...
        <thead className="thead-light">
          <tr>
            ...
            <th style={{width:"14%", alignContent:"center"}}>Receipt No</th>
            <th style={{width:"8", alignContent:"center"}}>Amount(Rs)</th>
                    ...
                    <table className="table" border="1" width="100%">
                        <tbody>
                            <tr>
                                ...
                                <td style={{width:"14%"}}>{receiptno.receiptno}</td>
                                <td style={{width:"8%"}}>{receiptno.amount}</td>
