    ...
    return (
        ...
        <form onSubmit={changeOnClick} encType="multipart/form-data">
            ...
            <div className="form-group">
                ...
                <input type="text" value={managerid} onChange={e => setManagerid(e.target.value)} className="form-control" placeholder="Description"/>
            </div>
            <div className="form-group">
            ...
            <div className="form-group">
                ...
                <select id="description" name="description" value={description} onChange={e => setDescription(e.target.value)} className="form-control">
