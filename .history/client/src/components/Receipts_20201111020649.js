            ...
            posts.map((receiptno,key) => (
                <div className="container" key={key}>
                    <table className="table" width="100%">
                        <tbody>
                            <tr>
                                <td style={{width:"12%"}}>{receiptno.uploadby}</td>
                                <td style={{width:"12%"}}>{receiptno.uploadby}</td>
                                ...
                                <td style={{width:"15%"}}>{receiptno.description}</td>
                                <td style={{width:"10%"}}>
