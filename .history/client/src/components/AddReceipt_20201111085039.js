...
const AddReceipt = () => {
const [uploadby, setUploader] = useState("195486F");
    ...
    return (
        ...
        <form onSubmit={changeOnClick} encType="multipart/form-data">
            ...
            <div className="form-group">
                ...
                <input 
                type="number"
                pattern="[0-9]" title="Only in numbers"
                required 
                value={amount} 
                onChange={e => 
            ...
            <div className="form-group">
                ...
                <select id="category" name="category" value={category} onChange={e => setCategory(e.target.value)} className="form-control" placeholder="Expense Category">
            ...
            <div className="form-group">
                ...
                <select id="description" name="description" value={description} onChange={e => setDescription(e.target.value)} className="form-control" placeholder="Payment Maethod">
