...
const Receipts = ({posts}) => {
    ...
    return (
        ...
        <thead className="thead-light">
          <tr>
            <th style={{width:"11%", alignContent:"center"}}>Employee ID</th>
            <th style={{width:"11%", alignContent:"center"}}>Manager ID</th>
            <th style={{width:"12%", alignContent:"center"}}>Receipt No</th>
            <th style={{width:"10", alignContent:"center"}}>Amount(Rs)</th>
            <th style={{width:"20%", alignContent:"center"}}>Date (YYYY/MM/DD:UTC)</th>
            <th style={{width:"10%", alignContent:"center"}}>Category</th>
            <th style={{width:"9%", alignContent:"center"}}>Method</th>
            <th style={{width:"9%", alignContent:"center"}}>Receipt</th>
            ...
            posts.map((receiptno,key) => (
                <div className="container" key={key}>
                    <table className="table" border="1" width="100%">
                        <tbody>
                            <tr>
                                <td style={{width:"11%"}}>{receiptno.uploadby}</td>
                                <td style={{width:"11%"}}>{receiptno.managerid}</td>
                                <td style={{width:"12%"}}>{receiptno.receiptno}</td>
                                <td style={{width:"10%"}}>{receiptno.amount}</td>
                                <td style={{width:"20%"}}>{receiptno.postDate}</td>
                                <td style={{width:"10%"}}>{receiptno.category}</td>
                                <td style={{width:"9%"}}>{receiptno.description}</td>
                                <td style={{width:"9%"}}>
