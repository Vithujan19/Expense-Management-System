...
const [payment,setEmployeeid] = useState("");
...
const [category, setCategory] = useState("");
    ...
    useEffect(() => {
        ...
        .then(res => [
            setEmployeeid(res.data.uploadby),
            setReceiptno(res.data.receiptno),
            setPayment(res.data.description),
    ...
    return (
        ...
        <form onSubmit={changeOnClick} encType="multipart/form-data">
            ...
            <div className="form-group">
                ...
                <select id="payment" name="payment" value={payment} onChange={e => setPayment(e.target.value)} className="form-control">
