        ...
        <form onSubmit={changeOnClick} encType="multipart/form-data">
            ...
            <div className="form-group">
                <ul>
                    <li>
                        <label>
                            <input type="radio"  checked={this.state.country === "card"} value={payMethod} onChange={e => setPayMethod(e.target.value)} />
                                <span>Card</span>
                            </label>
                    </li>
                    <li>
                        <label>
                            <input type="radio" checked={this.state.country === "cash"} value={payMethod} onChange={e => setPayMethod(e.target.value)} />
                                <span>Cash</span>
                            </label>
                    </li>
                </ul>    
